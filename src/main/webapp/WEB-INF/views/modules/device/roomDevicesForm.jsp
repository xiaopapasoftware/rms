...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/device/roomDevices/">房屋设备关联信息列表</a></li>
		<li class="active"><a href="${ctx}/device/roomDevices/form?id=${roomDevices.id}">房屋设备关联信息<shiro:hasPermission name="device:roomDevices:edit">${not empty roomDevices.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="device:roomDevices:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="roomDevices" action="${ctx}/device/roomDevices/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="device:roomDevices:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
