...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/person/partner/">合作人信息列表</a></li>
		<li class="active"><a href="${ctx}/person/partner/form?id=${partner.id}">合作人信息<shiro:hasPermission name="person:partner:edit">${not empty partner.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="person:partner:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="partner" action="${ctx}/person/partner/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">佣金百分比：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="person:partner:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
