...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/person/remittancer/">汇款人信息列表</a></li>
		<li class="active"><a href="${ctx}/person/remittancer/form?id=${remittancer.id}">汇款人信息<shiro:hasPermission name="person:remittancer:edit">${not empty remittancer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="person:remittancer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="remittancer" action="${ctx}/person/remittancer/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="person:remittancer:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
