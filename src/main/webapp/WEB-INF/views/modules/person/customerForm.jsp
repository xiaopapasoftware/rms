...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/person/customer/">客户信息列表</a></li>
		<li class="active"><a href="${ctx}/person/customer/form?id=${customer.id}">客户信息<shiro:hasPermission name="person:customer:edit">${not empty customer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="person:customer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
