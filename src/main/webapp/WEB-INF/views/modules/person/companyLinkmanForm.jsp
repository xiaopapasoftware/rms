...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/person/companyLinkman/">企业联系人列表</a></li>
		<li class="active"><a href="${ctx}/person/companyLinkman/form?id=${companyLinkman.id}">企业联系人<shiro:hasPermission name="person:companyLinkman:edit">${not empty companyLinkman.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="person:companyLinkman:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="companyLinkman" action="${ctx}/person/companyLinkman/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="personName" htmlEscape="false" maxlength="100" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="person:companyLinkman:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
