	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#btnExport").click(function(){
				$("#searchForm").attr("action","${ctx}/report/financial/exportPayment");
				$("#searchForm").submit();
				$("#searchForm").attr("action","${ctx}/report/financial/payment");
			});
		});
		function page(n,s){
			$("#pageNo").val(n);
...
<body>
	<form:form id="searchForm" modelAttribute="paymentReport" action="${ctx}/report/financial/payment" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		<c:forEach items="${page.list}" var="paymentReport">
			<tr>
				<td>
					${paymentReport.contractCode}
				</td>
				<td>
					${paymentReport.projectName}
				</td>
				<td>
					${paymentReport.buildingName}
				</td>
				<td>
					${paymentReport.houseNo}
				</td>
				<td>
					${paymentReport.custName}
				</td>
				<td>
					${paymentReport.depositAmount}
				</td>
				<td>
					${paymentReport.depositElectricAmount}
				</td>
				<td>
					${paymentReport.rental}
				</td>
				<td>
					${paymentReport.salesAmount}
				</td>
				<td>
					${paymentReport.received}
				</td>
				<td>
					${paymentReport.payment}
				</td>
				<td>
					<fmt:formatDate value="${paymentReport.expiredDate}" pattern="yyyy-MM-dd"/>
				</td>
				<td>
					${paymentReport.saler}
				</td>
