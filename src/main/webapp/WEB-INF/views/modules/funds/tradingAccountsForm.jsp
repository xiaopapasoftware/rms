...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/funds/tradingAccounts/form?id=${tradingAccounts.id}">账务交易<shiro:hasPermission name="funds:tradingAccounts:edit">${not empty tradingAccounts.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="funds:tradingAccounts:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tradingAccounts" action="${ctx}/funds/tradingAccounts/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="tradeId" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="tradeTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="payeeName" htmlEscape="false" maxlength="100" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="payeeType" class="input-xlarge required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="tradeStatus" class="input-xlarge required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
