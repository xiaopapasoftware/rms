...
public class ContractReport extends DataEntity<ContractReport> {
    private static final long serialVersionUID = 5465865092220963749L;
    ...
    @ExcelField(title = "合同到期日期", align = 2, sort = 8)
    ...
    @ExcelField(title = "下期租金支付时间", align = 2, sort = 9)
