...
public class ContractTenant extends DataEntity<ContractTenant> {
  ...
  private String depositAgreementId; // 承租的定金协议
  private String contractId; // 入住的出租合同
  private String leaseContractId; // 承租的出租合同
  private String agreementChangeId; // 入住的变更协议
