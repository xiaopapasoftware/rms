...
call mvn install:install-file -Dfile=../lib/XingeApp.jar -DgroupId=com.xinge -DartifactId=xinge -Dversion=1.0 -Dpackaging=jar -DlocalRepositoryPath=D:\m2\repository
call mvn install:install-file -Dfile=../lib/javabase64-1.3.1.jar -DgroupId=com.javabase64 -DartifactId=javabase64 -Dversion=1.0 -Dpackaging=jar -DlocalRepositoryPath=D:\m2\repository
pause