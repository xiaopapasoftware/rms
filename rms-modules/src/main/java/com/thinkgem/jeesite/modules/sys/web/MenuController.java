...
public class MenuController extends BaseController {
  ...
  public String save(Menu menu, Model model, RedirectAttributes redirectAttributes) {
    if (!UserUtils.getUser().isAdmin()) {
      addMessage(redirectAttributes, ViewMessageTypeEnum.ERROR, "越权操作，只有超级管理员才能添加或修改数据！");
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "保存菜单'" + menu.getName() + "'成功");
    return "redirect:" + adminPath + "/sys/menu/";
  }
  ...
  public String delete(Menu menu, RedirectAttributes redirectAttributes) {
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "删除菜单成功");
    // }
    return "redirect:" + adminPath + "/sys/menu/";
  }
  ...
  public String updateSort(String[] ids, Integer[] sorts, RedirectAttributes redirectAttributes) {
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "保存菜单排序成功!");
    return "redirect:" + adminPath + "/sys/menu/";
  }
