...
public class ActModelController extends BaseController {
  ...
  public String deploy(String id, RedirectAttributes redirectAttributes) {
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, actModelService.deploy(id));
  ...
  public String updateCategory(String id, String category, RedirectAttributes redirectAttributes) {
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "设置成功，模块ID=" + id);
  ...
  public String delete(String id, RedirectAttributes redirectAttributes) {
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "删除成功，模型ID=" + id);
    return "redirect:" + adminPath + "/act/model";
  }
}
