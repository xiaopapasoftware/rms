...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.thinkgem.jeesite.modules.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.thinkgem.jeesite.modules.entity.User(null, userId)))){
