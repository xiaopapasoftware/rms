...
public class CategoryController extends BaseController {
  ...
  public String save(Category category, Model model, RedirectAttributes redirectAttributes) {
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "保存栏目'" + category.getName() + "'成功");
    return "redirect:" + adminPath + "/cms/category/";
  }
  ...
  public String delete(Category category, RedirectAttributes redirectAttributes) {
    ...
    if (Category.isRoot(category.getId())) {
      addMessage(redirectAttributes, ViewMessageTypeEnum.ERROR, "删除栏目失败, 不允许删除顶级栏目或编号为空");
    } else {
      categoryService.delete(category);
      addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "删除栏目成功");
    }
    return "redirect:" + adminPath + "/cms/category/";
  }
  ...
  public String updateSort(String[] ids, Integer[] sorts, RedirectAttributes redirectAttributes) {
    ...
    addMessage(redirectAttributes, ViewMessageTypeEnum.SUCCESS, "保存栏目排序成功!");
    return "redirect:" + adminPath + "/cms/category/";
  }
