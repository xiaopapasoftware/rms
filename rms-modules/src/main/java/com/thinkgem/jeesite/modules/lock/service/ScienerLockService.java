...
public class ScienerLockService {
    ...
    public void init() {
        ...
        lockScienerV1 = global.getConfig("lock.sciener.v1");
        lockScienerV2 = global.getConfig("lock.sciener.v2");
        lockScienerUser = global.getConfig("lock.sciener.user");
        redirectUri = global.getConfig("lock.sciener.redirecturi");
        clientId = global.getConfig("lock.sciener.clientId");
        clientSecret = global.getConfig("lock.sciener.clientSecret");
        managerName = global.getConfig("lock.sciener.managerName");
        managerPwd = global.getConfig("lock.sciener.managerPwd");
    }
