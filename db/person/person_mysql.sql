...
CREATE TABLE `t_lessor` (
	`ID` VARCHAR(64) NOT NULL,
	`NAME` VARCHAR(100) NULL DEFAULT NULL COMMENT '姓名',
	`SOCIAL_NUMBER` VARCHAR(100) NULL DEFAULT NULL COMMENT '身份证号',
	`CELL_PHONE` VARCHAR(100) NULL DEFAULT NULL COMMENT '手机号',
	`GENDER` CHAR(1) NULL DEFAULT NULL COMMENT '性别',
	`ADDRESS` VARCHAR(300) NULL DEFAULT NULL COMMENT '详细居住地址',
