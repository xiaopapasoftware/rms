...
public abstract class BaseService {
     ...
     * @example dataScopeFilter(user, "dsf", "id=a.office_id", "id=a.create_by"); dataScopeFilter(entity, "dsf", "code=a.jgdm", "no=a.cjr"); // 适应于业务表关联不同字段时使用，如果关联的不是机构id是code。
     */
     ...
     * @example dataScopeFilter(areaWheres, "dsf", "id=a.office_id", "id=a.create_by");
     */
     ...
     * @example dataScopeFilter(areaWheres, "dsf", "id=a.office_id", "id=a.create_by");
     */
    public static String areaScopeFilter(String areaWheres) {
