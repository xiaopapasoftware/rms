        ...
        Controller: {
            ...
            query: function () {
                ...
                $.getJSON(url, FinanceReportMVC.Controller.params(), function (rep) {
                    ...
                    $("#outTotalAmount").html(rep.data.totalAmount.sumOutTotalAmount);
                    $("#houseDepositRefund").html(rep.data.totalAmount.sumHouseDepositRefund);
                    $("#waterDepositRefund").html(rep.data.totalAmount.sumWaterDepositRefund);
                    $("#houseRefund").html(rep.data.totalAmount.sumHouseRefund);
                    $("#eleRefund").html(rep.data.totalAmount.sumEleRefund);
                    $("#waterRefund").html(rep.data.totalAmount.sumWaterRefund);
                    $("#netRefund").html(rep.data.totalAmount.sumNetRefund);
                    $("#tvRefund").html(rep.data.totalAmount.sumTvRefund);
                    $("#otherRefund").html(rep.data.totalAmount.sumOtherRefund);
                });
            },
