...
<link href="${ctxStatic}/jquery-select2/4.0.3/dist/css/select2.min.css" rel="stylesheet"/>
<script src="${ctxStatic}/jquery-select2/4.0.3/dist/js/select2.min.js" type="text/javascript"></script>
