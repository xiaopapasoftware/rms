			...
			<tr <c:if test="${rentContract.contractBusiStatus=='7'||rentContract.contractBusiStatus=='8'||rentContract.contractBusiStatus=='9'||rentContract.contractBusiStatus=='16'}">style="background-color:#f1f2f2;"</c:if>>
				...
				<td>
					...
					<shiro:hasPermission name="contract:superRentContract:edit">
						...
						<c:if test="${rentContract.contractStatus=='6' && (rentContract.contractBusiStatus=='4' || rentContract.contractBusiStatus=='5' || rentContract.contractBusiStatus=='6' || rentContract.contractBusiStatus=='10' || rentContract.contractBusiStatus=='11' || rentContract.contractBusiStatus=='12')}">
