...
<head>
    ...
    <script type="text/javascript">
            ...
            $("#inputForm").validate({
                submitHandler: function (form) {//单间
                    ...
                    if ($("#hasFree").attr('checked') && (freeMonths == null || freeMonths == "" || freeMonths == undefined)) {
                        top.$.jBox.tip('促销优惠金额占月租百分比不可为空！', 'warning');
                        return;
                    }
                    var number = parseFloat(freeMonths);
                    if ($("#hasFree").attr('checked') &&  number <= 0) {
                        top.$.jBox.tip('减免房租金额占月租百分比不能小于0！', 'warning');
                        return;
                    }
        ...
        function addTenant() {
            top.$.jBox.open("iframe:${ctx}/person/tenant/add?type=tenant", '添加承租人', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addLive() {
            top.$.jBox.open("iframe:${ctx}/person/tenant/add?type=live", '添加入住人', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addProject() {
            top.$.jBox.open("iframe:${ctx}/inventory/propertyProject/add", '添加物业项目', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addBuilding() {
            ...
            top.$.jBox.open("iframe:${ctx}/inventory/building/add?propertyProject.id=" + $("[id='propertyProject.id']").val(), '添加楼宇', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addHouse() {
            ...
            top.$.jBox.open("iframe:${ctx}/inventory/house/add?building.id=" + $("[id='building.id']").val() + "&propertyProject.id=" + $("[id='propertyProject.id']").val() + "&houseStatus=1", '添加房屋', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addRoom() {
            ...
            top.$.jBox.open("iframe:${ctx}/inventory/room/add?building.id=" + $("[id='building.id']").val() + "&propertyProject.id=" + $("[id='propertyProject.id']").val() + "&house.id=" + $("[id='house.id']").val() + "&roomStatus=1", '添加房间', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addPartner() {
            top.$.jBox.open("iframe:${ctx}/person/partner/add", '添加合作人', 850, 500, {
                buttons: {'保存': '1', '关闭': '2'},
                submit: saveHandler
            });
        }
...
<ul class="nav nav-tabs">
    ...
    <li class="active">
        <a href="${ctx}/contract/rentContract/form?id=${rentContract.id}">
            出租合同<shiro:hasPermission name="contract:rentContract:edit"><c:if
                test="${rentContract.contractStatus=='0' || rentContract.contractStatus=='3'||rentContract.contractStatus=='1'}">修改</c:if><c:if
                test="${rentContract.contractStatus!='0' && rentContract.contractStatus!='3' && rentContract.contractStatus!='1'}">${not empty rentContract.id?'查看':'添加'}</c:if></shiro:hasPermission><shiro:lacksPermission
                name="contract:rentContract:edit">查看</shiro:lacksPermission>
        </a>
    </li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="rentContract" action="${ctx}/contract/rentContract/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><font color="red">*</font> </span>
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addProject()">添加物业项目</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><font color="red">*</font> </span>
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addBuilding()">添加楼宇</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><font color="red">*</font> </span>
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addHouse()">添加房屋</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addRoom()">添加房间</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">是否房租全免：</label>
        <div class="controls">
            <form:checkbox id="derateRentFlag" path="derateRentFlag" value="1" style="line-height: 30px; height: 30px;"
                           onclick="changeDerateRentFlag(this)"/>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        <label class="control-label"><c:if test="${empty renew}">水电押金金额：</c:if><c:if
                test="${not empty renew}">水电押金差额：</c:if></label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label"><c:if test="${empty renew}">房租押金金额：</c:if><c:if
                test="${not empty renew}">房租押金差额：</c:if></label>
        <div class="controls">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input type="number" placeholder="请填写正整数" id="depositMonths" path="depositMonths" htmlEscape="false"
                        maxlength="2" class="input-xlarge digits required"/>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><font color="red">*</font> </span>
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addTenant()">添加承租人</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><font color="red">*</font> </span>
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addLive()">添加入住人</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <shiro:hasPermission name="contract:rentContract:edit"><a href="#"
                                                                      onclick="addPartner()">添加合作人</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="chargeType" class="input-xlarge required">
                <form:option value="" label="请选择..."/>
                <form:options items="${fns:getDictList('charge_type')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/>
            </form:select>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="signDate" id="signDate" type="text" readonly="true" maxlength="20"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="startDate" id="startDate" type="text" readonly="true" maxlength="20"
                   class="input-medium Wdate required"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="expiredDate" id="expireDate" type="text" readonly="true" maxlength="20"
                   class="input-medium Wdate required"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="remindTime" id="remindTime" type="text" readonly="true" maxlength="20"
                   class="input-medium Wdate required"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:checkbox id="hasFree" path="hasFree" value="1" style="line-height: 30px; height: 30px;"
                           onclick="isHasFree(this)"/>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <form:input type="number" placeholder="请填写正整数" id="freeMonths" path="freeMonths" htmlEscape="false"
                        maxlength="3" class="input-xlarge digits"/><font color="red" size="6px">%</font>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">销售：</label>
        <div class="controls">
            <sys:treeselect id="user" name="user.id" value="${rentContract.user.id}" labelName="user.name"
                            labelValue="${rentContract.user.name}"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <c:if test="${'2'==rentContract.dataSource && rentContract.contractStatus != '0'}">
                <a target="_blank"
                   href="http://rms.tangroom.com:12302/rms-api/rentContractAgreement.html?id=${rentContract.id}">合同附件</a>
            </c:if>
            <c:if test="${'2'!=rentContract.dataSource}">
                <form:hidden id="rentContractFile" path="rentContractFile" htmlEscape="false" maxlength="4000"
                             class="input-xlarge"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:hidden id="rentContractCusIDFile" path="rentContractCusIDFile" htmlEscape="false" maxlength="4000"
                         class="input-xlarge"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:hidden id="rentContractOtherFile" path="rentContractOtherFile" htmlEscape="false" maxlength="4000"
                         class="input-xlarge"/>
    ...
    <div class="form-actions">
        ...
        <shiro:hasPermission name="contract:rentContract:audit">
            <c:if test="${rentContract.contractBusiStatus!=null&&rentContract.contractBusiStatus!='0'&&rentContract.contractBusiStatus!='1'&&rentContract.contractBusiStatus!='2'&&rentContract.contractBusiStatus!='3'&&rentContract.contractBusiStatus!='14'&&rentContract.contractBusiStatus!='15'}">
                <input class="btn btn-primary" type="button" value="查看退租核算"
                       onclick="viewCheckInfo('${rentContract.id}')"/>
            </c:if>
            <c:if test="${rentContract.contractStatus=='2'}">
                <input id="btnCancel" class="btn btn-primary" type="button" value="审 核"
                       onclick="toAudit('${rentContract.id}','1')"/>
            </c:if>
            <c:if test="${rentContract.contractBusiStatus=='17'}">
                <input id="btnCancel" class="btn btn-primary" type="button" value="审 核"
                       onclick="toAudit('${rentContract.id}','2')"/>
            </c:if>
        </shiro:hasPermission>
