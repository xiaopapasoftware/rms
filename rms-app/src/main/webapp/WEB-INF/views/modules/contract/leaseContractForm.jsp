...
<head>
    ...
    <script type="text/javascript">
        ...
        function addHouse() {
            ...
            top.$.jBox.open("iframe:${ctx}/inventory/house/add?building.id=" + $("[id='building.id']").val() + "&propertyProject.id=" + $("[id='propertyProject.id']").val(), '添加房屋', 850, 500, {
                buttons: {
                    '保存': '1',
                    '关闭': '2'
                }, submit: saveHandler
        ...
        function addRemittancer() {
            top.$.jBox.open("iframe:${ctx}/person/remittancer/add", '添加汇款人', 850, 500, {
                buttons: {'保存': '1', '关闭': '2'},
                submit: saveHandler
            });
        }
...
<ul class="nav nav-tabs">
    ...
    <li class="active">
        <a href="#">承租合同<shiro:hasPermission name="contract:leaseContract:edit"><c:if
                test="${leaseContract.contractStatus=='0'||leaseContract.contractStatus=='2'||empty leaseContract.id}">${not empty leaseContract.id?'修改':'添加'}</c:if><c:if
                test="${leaseContract.contractStatus=='1'}"><span>查看</span></c:if></shiro:hasPermission><shiro:lacksPermission
                name="contract:leaseContract:edit">查看</shiro:lacksPermission></a>
    </li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="leaseContract" action="${ctx}/contract/leaseContract/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="help-inline"><font color="red">*</font> </span>
            <shiro:hasPermission name="contract:leaseContract:edit"><a href="#"
        ...
        <div class="controls">
            <form:select path="remittancer.id" class="input-xlarge required" style="width:450px;">
                ...
                <c:forEach items="${remittancerList}" var="item">
                    <form:option
                            value="${item.id}">${item.userName} - ${item.bankName} - ${item.bankAccount}</form:option>
                </c:forEach>
            </form:select>
            <span class="help-inline"><font color="red">*</font></span>
            <shiro:hasPermission name="contract:leaseContract:edit"><a href="#"
                                                                       onclick="addRemittancer()">添加汇款人</a></shiro:hasPermission>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">合同签订时间：</label>
        <div class="controls">
            <input name="contractDate" type="text" readonly="readonly" maxlength="20"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="effectiveDate" type="text" readonly="readonly" maxlength="20"
                   class="input-medium Wdate required"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="firstRemittanceDate" type="text" readonly="readonly" maxlength="20"
                   class="input-medium Wdate required"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="remittanceDate" class="input-xlarge required">
                <form:option value="" label="请选择..."/>
                <form:options items="${fns:getDictList('remittance_date')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/>
            </form:select>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:hidden id="trusteeshipContr" path="trusteeshipContr" htmlEscape="false" maxlength="4000"
                         class="input-xlarge"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
                ...
                <shiro:hasPermission name="contract:leaseContract:edit">
                    ...
                    <tr>
                        <td colspan="4"><a href="javascript:"
                                           onclick="addRow('#leaseContractDtlList', leaseContractDtlRowIdx, leaseContractDtlTpl);leaseContractDtlRowIdx = leaseContractDtlRowIdx + 1;"
                                           class="btn">新增</a></td>
                    </tr>
                    </tfoot>
                </shiro:hasPermission>
            ...
            <script type="text/javascript">
                var leaseContractDtlRowIdx = 0,
                    leaseContractDtlTpl = $("#leaseContractDtlTpl").html().replace(/(\/\/\<!\-\-)|(\/\/\-\->)/g, "");
                $(document).ready(function () {
        ...
        <shiro:hasPermission name="contract:leaseContract:audit">
            <c:if test="${leaseContract.contractStatus=='0'}">
                <input id="btnSubmit" class="btn btn-primary" type="button" value="审 核"
                       onclick="toAudit('${leaseContract.id}')"/>
            </c:if>
        </shiro:hasPermission>
