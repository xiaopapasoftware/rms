...
<body>
	...
	<form:form id="searchForm" modelAttribute="accounting" action="${ctx}/contract/accounting/list" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<shiro:hasPermission name="contract:accounting:view">
