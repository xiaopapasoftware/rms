            ...
            <form id="queryFrom" class="layui-form layui-form-item layui-form-pane">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline m-large" style="width: 200px;">
                        <input type="text" id="otherReadDates" name="otherReadDates" placeholder="计算日期" readonly
                               class="layui-input">
                    </div>
                </div>
            </form>
...
<script src="${ctxStatic}/modules/fee/other/feeOtherChargeFlow.js"></script>
</body>
</html>