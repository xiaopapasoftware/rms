...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/person/owner/">业主信息列表</a></li>
		<li class="active"><a href="${ctx}/person/owner/form?id=${owner.id}">业主信息<shiro:hasPermission name="person:owner:edit">${not empty owner.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="person:owner:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="owner" action="${ctx}/person/owner/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="person:owner:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
