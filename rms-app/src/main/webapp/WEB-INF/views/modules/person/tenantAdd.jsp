...
<body>
	<ul class="nav nav-tabs">
		<li>
			<a href="${ctx}/person/customer/">客户信息列表</a>
		</li>
		<li>
			<a href="${ctx}/person/customer/form?id=${customer.id}">客户信息<shiro:hasPermission name="person:customer:edit">${not empty customer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="person:customer:edit">查看</shiro:lacksPermission></a>
		</li>
		<li class="active">
			<a href="javascript:void(0);">租客信息添加</a>
		</li>
	</ul>
	<br/>
	<form:form id="inputForm" modelAttribute="tenant" action="${ctx}/person/customer/saveTenant" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="tenantName" htmlEscape="false" maxlength="100" class="input-xlarge required" readonly="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="gender" class="input-xlarge required" readonly="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="cellPhone" htmlEscape="false" maxlength="64" class="input-xlarge required"  readonly="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="person:customer:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
