...
<form:form id="searchForm" modelAttribute="custBindInfo" action="${ctx}/person/custBindInfo/" method="post"
        ...
        <tr>
            ...
            <td>
                <shiro:hasPermission name="person:custBindInfo:edit">
                    <a href="${ctx}/person/custBindInfo/delete?id=${custBindInfo.id}"
